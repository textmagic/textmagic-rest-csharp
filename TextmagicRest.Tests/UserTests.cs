...
namespace TextmagicRest.Tests
{
    ...
    public class UserTests
    {
        ...
        public void ShouldCreateSenderId()
        {
            ...
            var senderIdToCreate = "senderIdToCreate";
            var explanation = "why_I_want_a_senderid";
        ...
        public void ShouldGetAvailableSendingSources()
        {
            ...
            var content =
                "{ \"dedicated\": null, \"user\": [], \"shared\": [\"12345\",\"390866\"], \"senderIds\": null }";
        ...
        public void ShouldGetDedicatedNumber()
        {
            ...
            var content =
                "{ \"id\": 1, \"phone\": \"3435657\", \"country\": null, \"status\": \"A\", \"purchasedAt\": null, \"expireAt\": null, \"user\": null }";
        ...
        public void ShouldGetDedicatedNumbers()
        {
            ...
            var content =
                "{ \"page\": 1, \"limit\": 1, \"pageCount\": 1, \"resources\": [ { \"id\": 1, \"phone\": \"3435657\", \"country\": null, \"status\": \"A\", \"purchasedAt\": null, \"expireAt\": null, \"user\": null } ] }";
        ...
        public void ShouldGetSenderIds()
        {
            ...
            var content =
                "{ \"page\": 1, \"limit\": 1, \"pageCount\": 1, \"resources\": [ { \"Id\": 37, \"senderId\": \"NameOfSenderId\", \"status\": \"A\", \"user\": null } ] }";
        ...
        public void ShouldGetSingleSubaccount()
        {
            ...
            var content =
                "{\"id\": 12345, \"username\": \"api.test.user\", \"firstName\": \"Test\", \"lastName\": \"Api\",  \"status\": \"T\", \"balance\": 575.5,  \"company\": \"test company\","
        ...
        public void ShouldGetSubAccounts()
        {
            ...
            var content =
                "{ \"page\": 1, \"limit\": 1, \"pageCount\": 1, \"resources\": [ {\"id\": 12345, \"username\": \"api.test.user\", \"firstName\": \"Test\", \"lastName\": \"Api\",  \"status\": \"T\", \"balance\": 575.5,  \"company\": \"test company\", \"currency\": { \"id\": \"EUR\", \"htmlSymbol\": null }, \"timezone\": null, \"subaccountType\": \"P\"} ] }";
