...
namespace TextmagicRest.Tests
{
    ...
    public class TemplatesTests
    {
        ...
        private readonly DateTime date = new DateTime(2015, 05, 07, 06, 05, 55, 0, DateTimeKind.Utc);
        ...
        public void ShouldGetAllTemplates()
        {
            ...
            foreach (var template in templates.Templates)
            {
                ...
                Assert.AreEqual(date, template.LastModified);
                currentIteration++;
            }
        }
        ...
        public void ShouldGetSingleTemplate()
        {
            ...
            var content =
                "{ \"id\": \"51335\", \"name\": \"Template name\", \"content\": \"Template content\", \"lastModified\": \"2015-05-07T06:05:55+0000\" }";
        ...
        public void ShouldSearchTemplates()
        {
            ...
            var templateContent = "my template content";
            ...
            Assert.AreEqual(page.ToString(), savedRequest.Parameters.Find(x => x.Name == "page").Value);
            Assert.AreEqual(limit.ToString(), savedRequest.Parameters.Find(x => x.Name == "limit").Value);
            Assert.AreEqual(name, savedRequest.Parameters.Find(x => x.Name == "name").Value);
            Assert.AreEqual(templateContent, savedRequest.Parameters.Find(x => x.Name == "content").Value);
            ...
            Assert.AreEqual(date, templates.Templates[0].LastModified);
        }
